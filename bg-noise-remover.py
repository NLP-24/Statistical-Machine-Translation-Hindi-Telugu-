...
destination_directory = r"D:\Assignments\NLP project\Statistical-Machine-Translation-Hindi-Telugu-\data-bg-cleaned"  # Replace with the path to the 'data-bg-cleaned' folder
