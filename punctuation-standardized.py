...
# Directory paths
source_directory = r"./data-bg-cleaned"
destination_directory = r"./data-punctuation-standardized"
...
print("All files have been processed and saved to 'data-punctuation-standardized'.")