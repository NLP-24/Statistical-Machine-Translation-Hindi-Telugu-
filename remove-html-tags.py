...
source_base_dir = 'Statistical-Machine-Translation-Hindi-Telugu-\data-lang-cleaned'  # Replace with the actual path to your data folder
destination_base_dir = 'Statistical-Machine-Translation-Hindi-Telugu-\data-Html-cleaned'  # Replace with the actual path to your data-bg-cleaned folder
