...
source_directory = "data-Html-cleaned"  # Replace with the path to the 'data-encoded' folder
destination_directory = "data-unprintable-cleaned"  # Replace with the path to the 'data-unprintable-cleaned' folder
